...
// カフェ・レストラン特集（常設・トップ表示）。新しい店舗が見つかったら各都市配列に追記していく。
const FEATURED_CAFE_RESTAURANT = {
  label: "☕ カフェ・レストラン特集",
  cities: {
    sydney: { name: "Sydney", emoji: "🔵", jobs: [
      { title: "Floor Staff", company: "Cinder Restaurant", location: "Barangaroo NSW 2000", schedule: "Part-time/Casual/Permanent/Full-timeから選択可", requirements: ["接客業経験があること", "ポジティブな姿勢でゲスト体験を大切にできること"], description: "新規オープン施設でゲスト対応・オーダー対応・サービス全般を担当", wage: "$28.00〜$35.00/hr", url: "https://au.indeed.com/viewjob?jk=481d79744b6a92d1", source: "Indeed" },
      { title: "Front of House All-Rounder", company: "Fins and Ribs", location: "Manly Beach NSW 2095", schedule: "Part-time/Full-time/Casual、週末・祝日勤務必須", requirements: ["NSW RSA資格必須", "飲食店勤務経験（バリスタ・バーテンダー経験は歓迎）"], description: "ゲスト対応・オーダー取得・料理説明・POS操作などホール業務全般", wage: "$27.00〜$30.00/hr", url: "https://au.indeed.com/viewjob?jk=6f7689a739b4e81a", source: "Indeed" },
      { title: "Barista and Bakery", company: "Muffin Break（Hornsby店）", location: "Hornsby NSW 2077", schedule: "カジュアル、週末勤務可能な方", requirements: ["バリスタ経験3年以上", "忙しいカフェでの対応力とベーキング業務への意欲"], description: "コーヒー製造・ベーキング・接客・POS操作などカフェ業務全般", wage: "$34.76/hr〜", url: "https://au.indeed.com/viewjob?jk=103ed9532f0cf019", source: "Indeed" },
      { title: "Waiter/Waitress", company: "Jambo Jambo Africa", location: "Glebe NSW 2037", schedule: "カジュアル、夜間シフト中心、週末勤務歓迎", requirements: ["時間厳守で信頼できること", "接客業経験は歓迎だが必須ではない"], description: "アフリカ料理レストランでのホール接客サービス", wage: "$27.00〜$28.00/hr", url: "https://au.indeed.com/viewjob?jk=e1e8bee30cf99b5f", source: "Indeed" },
      { title: "Section Waiters", company: "Firepop", location: "Enmore NSW 2042", schedule: "Full-time/Part-time/Casual、週5日勤務", requirements: ["同職種経験必須", "就労権保有必須（RSA歓迎）"], description: "担当セクションでのテーブルサービス・ワインサービス、キッチンと連携したメニュー説明", wage: "$30.00〜$40.00/hr", url: "https://au.indeed.com/viewjob?jk=24dca5874709adbe", source: "Indeed" },
      { title: "Cafe All Rounder/Barista", company: "Kiosk Cronulla", location: "Cronulla NSW 2230", schedule: "週24時間、木〜土曜、早朝5:30am〜勤務可能な方", requirements: ["バリスタ/カフェ経験2年以上", "早朝勤務が可能なこと"], description: "ビーチ沿いカフェでのエスプレッソマシン操作・サンドイッチ調理などカフェ業務全般", wage: "$33.85〜$40.62/hr", url: "https://au.indeed.com/viewjob?jk=6c404a43e799135d", source: "Indeed" },
    ]},
    melbourne: { name: "Melbourne", emoji: "🟠", jobs: [
      { title: "Barista/All Rounder", company: "Sir Charles Cafe", location: "Fitzroy VIC 3065", schedule: "週7日ローテーション制、シフト勤務", requirements: ["バリスタ経験2年以上", "レジ・POS操作、ハイボリューム店舗での接客経験"], description: "新しくオープンしたフィッツロイの人気カフェで、質の高いコーヒー提供と接客を行う", wage: "$26.00〜$35.13/hr", url: "https://au.indeed.com/viewjob?jk=0ce284c222fff3b6", source: "Indeed" },
      { title: "Front of House Team Member (Barista)", company: "Hector's Deli", location: "Melbourne CBD VIC 3000", schedule: "カジュアル雇用（日数応相談）", requirements: ["ハイボリューム店舗でのバリスタ経験", "サンドイッチ調理サポート可能なこと"], description: "繁盛店のデリで、コーヒー提供・接客・軽食サポートを行うフロントスタッフ", wage: "$33.19〜$40.00/hr", url: "https://au.indeed.com/viewjob?jk=a11ceb6afb5a7067", source: "Indeed" },
      { title: "Cafe All Rounder", company: "Cafe Safi", location: "484 St Kilda Road, Melbourne VIC 3004", schedule: "月〜金、朝8時スタート（パートタイム）", requirements: ["カフェでの実務経験", "食品衛生基準の遵守とチームワーク"], description: "忙しいメルボルンのカフェで、接客からドリンク・軽食提供までこなすオールラウンダー業務", wage: "$26.44〜$41.86/hr", url: "https://au.indeed.com/viewjob?jk=918604d298ebbbeb", source: "Indeed" },
      { title: "Barista", company: "MORI COFFEE", location: "1 Main Street, Blackburn VIC 3130", schedule: "デイシフト、週末対応可能なこと", requirements: ["バリスタ経験1年以上", "接客・食品取扱経験1年以上"], description: "東部郊外の人気カフェで、コーヒー提供から接客・店内維持までを担当", wage: "$23.90〜$34.61/hr", url: "https://au.indeed.com/viewjob?jk=b85c1727f757995e", source: "Indeed" },
      { title: "Barista/All Rounder", company: "Bean Lab（Queen St）", location: "174 Queen Street, Melbourne VIC 3000", schedule: "月〜金の朝シフト＋週末対応可能なこと", requirements: ["バリスタ／オールラウンダー経験必須（未経験不可）"], description: "CBDのカフェでコーヒー提供、軽食（サンドイッチ）調理、レジ対応、清掃を行う", wage: "$27.00〜$30.00/hr", url: "https://au.indeed.com/viewjob?jk=28f5e866853727d6", source: "Indeed" },
      { title: "Barista/All Rounder", company: "My Cafe & Eatery", location: "Pakenham VIC 3810", schedule: "月〜金の朝シフト＋週末対応可能なこと", requirements: ["バリスタ経験2年以上", "チームワークとマルチタスク能力"], description: "地域密着型カフェで、コーヒー提供と接客を担当する", wage: "$25.00〜$30.00/hr", url: "https://au.indeed.com/viewjob?jk=37aec34681ee9417", source: "Indeed" },
    ]},
    brisbane: { name: "Brisbane / Gold Coast", emoji: "🟡", jobs: [
      { title: "Food Service / Front of House Team Member", company: "Marco Polo Kitchen", location: "140 Creek Street, Brisbane City QLD 4000", schedule: "月〜金 6:30am–3:00pm（カジュアル）、週末・祝日勤務あり", requirements: ["英語コミュニケーション能力必須", "カフェ・接客経験は歓迎だが必須ではない"], description: "ブリスベンCBDのオフィスビル内カフェで食事の準備・提供・ディスプレイ管理を行う", wage: "$34.00/hr〜", url: "https://au.indeed.com/viewjob?jk=f634c49df8524629", source: "Indeed" },
      { title: "Barista all rounder", company: "Muffin Break（Brisbane Central）", location: "Brisbane QLD 4000", schedule: "パート・カジュアル、週末勤務必須、早朝5amスタートあり", requirements: ["経験者歓迎だが未経験でも研修あり", "接客・レジ対応スキル"], description: "賑わうカフェでバリスタ業務と接客サービスを担当", wage: "$34.00〜$41.00/hr", url: "https://au.indeed.com/viewjob?jk=e5a98e87874371f1", source: "Indeed" },
      { title: "Sushi Roll Maker / Hot Food Maker", company: "Sushi & Nori", location: "Corner of King & Machinery Street, Bowen Hills QLD 4006", schedule: "パート・フルタイム・カジュアルいずれも可", requirements: ["同様業務の経験1年以上", "有効なビザ（有効期限の証明が必要）"], description: "寿司ロールとホットフードの調理を担当", wage: "$30.91/hr（+ super、平日）", url: "https://www.jams.tv/classifieds/jobs/26623", source: "JAMS.TV" },
      { title: "Barista/All Rounder", company: "Humble Cafe", location: "Southport QLD 4215", schedule: "平日・週末・祝日、朝6時台スタートあり", requirements: ["バリスタ経験1年以上", "コマーシャルエスプレッソマシン操作可"], description: "専門店カフェでコーヒー抽出・接客・フロア業務を担当", wage: "$35.00/hr〜", url: "https://au.indeed.com/viewjob?jk=9e550cc4a96eb65f", source: "Indeed" },
      { title: "Casual FOH Allrounder", company: "Castaway Coffee Bar", location: "Surfers Paradise QLD 4217", schedule: "カジュアル、週末勤務必須、週25時間以上可", requirements: ["カフェ・レストラン経験1年程度", "英語での明確なコミュニケーション力"], description: "ビーチサイドのカフェで接客・オーダー対応・フロア運営を担当", wage: "$35.00/hr〜", url: "https://au.indeed.com/viewjob?jk=ab1342efce36b4a6", source: "Indeed" },
      { title: "Barista/All Rounder", company: "Leaf Cafe & Co", location: "Broadbeach QLD 4218", schedule: "パーマネント・パート・カジュアル", requirements: ["バリスタ経験1年程度（歓迎）", "POSシステム対応・フードランニング経験"], description: "モダンなカフェでコーヒー提供とテーブルサービスを担当", wage: "$27.00/hr〜", url: "https://au.indeed.com/viewjob?jk=e0a1bbc5daa31538", source: "Indeed" },
    ]},
    perth: { name: "Perth", emoji: "🟢", jobs: [
      { title: "Wait Staff", company: "Cup & Co", location: "1 Finishline View, Floreat WA 6014", schedule: "Part-time/Casual/Full-time、シフト制、週末勤務必須", requirements: ["ホスピタリティ経験2年以上", "週末勤務可能なこと"], description: "接客・注文受付(POS)・配膳・清掃、バリスタ/キッチンチームとの連携", wage: "$31.00〜$43.00/hr（経験に応じる）", url: "https://au.indeed.com/viewjob?jk=b605865e529ac80d", source: "Indeed" },
      { title: "Barista/All Rounder", company: "The Cutting Board Eathouse", location: "202 Pier Street, Perth WA 6000", schedule: "月〜金のみ、週末休み（朝食・ランチ営業）", requirements: ["バリスタ経験1年以上", "食品取扱経験1年以上、RSA資格必須"], description: "バリスタ業務およびフロント対応（スムージー・ジュース・サンドイッチ提供含む）", wage: "$32.00〜$33.00/hr", url: "https://au.indeed.com/viewjob?jk=24f3523de9d488e5", source: "Indeed" },
      { title: "Barista/All Rounder", company: "Jamaica Blue（Willetton Southlands）", location: "45 Burrendah Boulevard, Willetton WA 6155", schedule: "フルタイム/パートタイム/カジュアル、週末対応必須", requirements: ["カスタマーサービス経験1年推奨", "バリスタ経験1年推奨"], description: "忙しいカフェ環境でのコーヒー提供・接客", wage: "$24.00〜$36.59/hr", url: "https://au.indeed.com/viewjob?jk=a7bce692e22e2716", source: "Indeed" },
      { title: "All Rounder/Barista", company: "MRKT SPACE", location: "North Fremantle WA 6159", schedule: "カジュアル、シフト制", requirements: ["バリスタ経験者", "ラテアートスキルがあれば加点"], description: "コーヒー製造・接客・注文対応", wage: "$33.00〜$33.05/hr", url: "https://au.indeed.com/viewjob?jk=9bbdcfa47d2d4907", source: "Indeed" },
      { title: "Service Staff", company: "LA MINT Events & Catering", location: "2 Brodie-Hall Drive, Bentley WA 6102", schedule: "月〜金 20〜40時間、週末・夜間の可能性あり", requirements: ["関連職務経験2〜3年推奨", "柔軟なシフト対応可能なこと"], description: "カフェ・ケータリング部門のフロント業務サポート", wage: "$33.00〜$36.00/hr", url: "https://au.indeed.com/viewjob?jk=d38b6d30a233cbe5", source: "Indeed" },
      { title: "Sandwich Artist", company: "Get Ya Fix", location: "471 William Street, Perth WA 6000", schedule: "カジュアル、シフト制、週末対応必須", requirements: ["カフェ・テイクアウト経験1年以上", "有効な食品取扱証明書必須"], description: "サンドイッチ・ベーグル調理、テイクアウト注文対応、衛生管理", wage: "$31.00〜$39.00/hr", url: "https://au.indeed.com/viewjob?jk=f49a8bfb62ad12df", source: "Indeed" },
    ]},
    other: { name: "Other（Cairns・Adelaide）", emoji: "⚪", jobs: [
      { title: "Experienced Barista / Café All-Rounder", company: "Bolla Milano", location: "20 James Place, Adelaide SA 5000", schedule: "フルタイム/カジュアル、デイシフト中心", requirements: ["バリスタ経験2年以上", "忙しい環境で高品質なコーヒーを迅速に提供できること"], description: "アデレードCBDの人気イタリアンカフェでバリスタ業務とフロア業務全般を担当", wage: "$30.00〜$35.00/hr", url: "https://au.indeed.com/viewjob?jk=c94631e650735c02", source: "Indeed" },
      { title: "Front of House Staff (Waiter/Waitress)", company: "Sportivo Pizzeria and Cafe", location: "153 Brebner Drive, West Lakes SA 5021", schedule: "パートタイム/カジュアル、週末・夜間availability必須", requirements: ["フレンドリーで信頼できる対応力", "忙しい環境での接客経験（RSA歓迎）"], description: "湖畔のイタリアンレストランで接客・配膳・会計を担当", wage: "$26.44〜$44.48/hr", url: "https://au.indeed.com/viewjob?jk=6a8004af156dca45", source: "Indeed" },
      { title: "Casual Chef / Cook / Kitchen Hand", company: "Ergo Cafe", location: "Warradale SA 5046", schedule: "カジュアル、デイシフトのみ、週15〜30時間", requirements: ["カフェ・レストランでのシェフ経験", "フードセーフティ知識"], description: "人気ブランチカフェで新鮮な料理を調理するシェフ業務", wage: "$31.00〜$35.00/hr", url: "https://au.indeed.com/viewjob?jk=f16b5ed86c7045c7", source: "Indeed" },
      { title: "Food & Beverage Attendant", company: "Cater Care Australia（ケアンズ空港内）", location: "Cairns Airport, Cairns North QLD 4870", schedule: "パートタイム常勤、週20〜30時間保証、朝4時〜夜10時のローテーション", requirements: ["RSA資格保有", "運転免許＋移動手段があること"], description: "ケアンズ空港内のカフェ・レストランでコーヒーや軽食を提供", wage: "$27.08/hr〜（早朝・深夜・週末ペナルティ加算あり）", url: "https://au.indeed.com/viewjob?jk=1c7b2831f103ebf3", source: "Indeed" },
      { title: "Chef", company: "Ela Mediterranean（Ela Modern Bistro）", location: "Marlin Parade, Cairns QLD 4870", schedule: "カジュアル、週25時間以上、昼・夜シフト、週末含む", requirements: ["シェフ・ド・パルティとして3年以上の経験", "繁忙な厨房での勤務経験"], description: "ケアンズ・ウォーターフロントの地中海料理レストランでメニューの調理・後輩指導を担当", wage: "$36.81〜$44.18/hr", url: "https://au.indeed.com/viewjob?jk=8bcd3cb78ed21b9d", source: "Indeed" },
    ]},
  }
};
